...
/// ============================================================================
/// CAPTAIN WASEL - MOTION & MICRO-INTERACTION WIDGETS
/// ============================================================================
/// 60/120 FPS high-performance motion widgets tailored for couriers and captains.
/// Zero deprecations with Color.withValues, optimized with RepaintBoundary.
/// ============================================================================

/// 1. WaselBouncyPressable (Driver Edition)
...
/// 2. WaselPulseGlow (Driver Edition)
class WaselPulseGlow extends StatefulWidget {
  ...
  const WaselPulseGlow({
    super.key,
    required this.child,
    this.glowColor = DriverColors.onlineGreen,
    this.minBlur = 8.0,
    this.maxBlur = 24.0,
    this.minSpread = 1.0,
    this.maxSpread = 6.0,
        ...
        return RepaintBoundary(
          child: DecoratedBox(
            decoration: BoxDecoration(
              shape: widget.shape,
              borderRadius: widget.shape == BoxShape.circle ? null : (widget.borderRadius ?? DriverRadius.radiusMd),
              boxShadow: [
                BoxShadow(
...
/// 3. WaselRadarSweep (Driver Radar Pulse)
class WaselRadarSweep extends StatefulWidget {
  ...
  const WaselRadarSweep({
    super.key,
    this.size = 200.0,
    this.sweepColor = DriverColors.primary,
    this.ringColor = const Color(0x33D4AF37),
...
/// 4. WaselNumberOdometer (Driver Earnings Counter)
